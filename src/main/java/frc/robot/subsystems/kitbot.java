...
public class kitbot extends SubsystemBase {
  ...
  private static final int kCanID_neo1 = 14; 
  ...
  public kitbot() {
    ...
    m_motor_neo.configure(config, ResetMode.kResetSafeParameters,PersistMode.kPersistParameters);
  }
